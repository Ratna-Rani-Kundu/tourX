...
const About = () => {
    return (
        ...
        <Container>
            <Row>
              <Col>
              <img className="rounded" src="https://images.unsplash.com/photo-1553697388-94e804e2f0f6?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=465&q=80" alt="" />
